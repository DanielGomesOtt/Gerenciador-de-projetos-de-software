        ...
        <div>
            <div class="grid grid-cols-1 lg:grid-cols-3">
                <div class="text-center border-2 rounded-lg border-slate-500 shadow hover:shadow-xl hover:cursor-pointer w-96 h-20">
                    ...
                    <p class="text-2xl text-emerald-600 font-semibold">R$ {{ monthlyPlanToday }}</p>
                </div>
                <div class="text-center border-2 rounded-lg border-slate-500 shadow hover:shadow-xl hover:cursor-pointer w-96 h-20">
                    <p class="text-2xl font-bold">Monthly Plan This Month</p>
                    <p class="text-2xl text-emerald-600 font-semibold">R$ {{ monthlyPlanMonth }}</p>
                </div>
                <div class="text-center border-2 rounded-lg border-slate-500 shadow hover:shadow-xl hover:cursor-pointer w-96 h-20">
                    <p class="text-2xl font-bold">Monthly Plan This Year</p>
                    <p class="text-2xl text-emerald-600 font-semibold">R$ {{ monthlyPlanYear }}</p>
                </div>
            </div>
        </div>
    </div>
