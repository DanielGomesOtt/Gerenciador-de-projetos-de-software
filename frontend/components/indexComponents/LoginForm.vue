...
<template>
    <div class="grid grid-cols-1 pt-10 w-full md:flex md:flex-1 md:justify-center md:items-center lg:flex lg:flex-1 lg:justify-center lg:items-center">
        ...
        <div v-if="visibleLanguage == 'pt-br'">
            <h2 class="text-indigo-800 font-bold text-3xl md:text-4xl lg:text-4xl text-center">Acesse sua conta</h2>
            <p class="text-gray-500 font-lg text-lg md:text-xl lg:text-xl text-center mt-5">Entre e aproveite</p>
            <p class="text-red-500 text-center text-lg mt-5" v-if="errorMessageVisibility">{{ errorRequest }}</p>
