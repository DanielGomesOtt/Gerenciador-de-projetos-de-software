...
<template>
    <div class="grid pt-10 grid-cols-1 w-full md:flex md:flex-1 md:justify-center md:items-center lg:flex lg:flex-1 lg:justify-center lg:items-center">
        ...
        <div v-if="visibleLanguage == 'pt-br'">
            <h2 class="text-indigo-800 font-bold text-3xl md:text-4xl lg:text-4xl text-center">Crie sua conta</h2>
            <p class="text-gray-500 font-lg text-lg md:text-xl lg:text-xl text-center mt-5">Crie uma conta e aproveite</p>
            <div class="flex justify-center mt-5 text-red-600">{{ errorMessage }}</div>
            <div>
                <form @submit="submit($event)">
                    <div class="flex justify-center">
