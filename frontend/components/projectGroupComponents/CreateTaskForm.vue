    ...
    <div v-if="props.visibleLanguage == 'en'">
        ...
        <div class="w-full mt-10">
            ...
            <form class="w-[100%]">
                ...
                <div class="mt-2">
                    <label for="project-stage-task" class="font-semibold">Project stage</label>
                    <select class="w-full h-10 rounded mt-2 p-2 bg-slate-200 shadow" id="project-stage-task" name="project-stage-task" required v-model="task.project_stage">
    ...
    <div v-if="props.visibleLanguage == 'pt-br'">
        ...
        <div class="w-full mt-10">
            ...
            <form class="w-[100%]">
                ...
                <div class="mt-2">
                    <label for="project-stage-task" class="font-semibold">Etapa do projeto</label>
                    <select class="w-full h-10 rounded mt-2 p-2 bg-slate-200 shadow" id="project-stage-task" name="project-stage-task" required v-model="task.project_stage">
                        <option value="">Selecione a etapa do projeto</option>
