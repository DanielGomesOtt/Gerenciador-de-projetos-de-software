...
const chartLabelsPtbr = ['em andamento', 'atrasado', 'finalizado', 'cancelado'];
...
const printReport = () => {
    ...
    if(props.visibleLanguage == 'en'){
        ...
        <html>
            ...
            <body>
                <h2 style="text-align: center; font-size: 2rem; font-weight: bold; margin-bottom: 1rem;">Project Progress Report</h2>
    ...
    `;
        ...
        <html>
            ...
            <body>
                <h2 style="text-align: center; font-size: 2rem; font-weight: bold; margin-bottom: 1rem;">Relatório de progresso dos projetos</h2>
                <div class="overflow-auto">
                    ${table}
                </div>
            </body>
...
<template>
    <div class="flex justify-center w-full">
        <h2 class="text-2xl md:text-4xl font-bold text-center mb-14" v-if="props.visibleLanguage == 'en'">Projects Progress Report</h2>
        <h2 class="text-2xl md:text-4xl font-bold text-center mb-14" v-if="props.visibleLanguage == 'pt-br'">Relatório de progresso dos projetos</h2>
